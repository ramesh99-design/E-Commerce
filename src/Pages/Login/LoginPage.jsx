...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 py-12 bg-slate-950 text-slate-100 overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[400px] w-[600px] rounded-full bg-violet-600/15 blur-3xl pointer-events-none -z-0" />
        ...
        <div className="rounded-3xl border border-slate-800 bg-slate-900/80 p-8 backdrop-blur-2xl shadow-2xl shadow-black/80">
          ...
          <div className="text-center">
            ...
            <p className="mt-1 text-xs text-slate-400">
              Sign in to manage orders, wishlist, and fast checkout
            </p>
          </div>

          {/* Quick Demo Login Preset Button */}
          <div className="mt-6 rounded-2xl border border-violet-500/30 bg-violet-500/10 p-3 flex items-center justify-between">
            ...
            <button
              ...
              className="rounded-lg bg-violet-600 px-3 py-1 text-[11px] font-bold text-white shadow-sm hover:bg-violet-500 transition-colors"
            >
